...
const Skills = () => {
  return (
    <div name='skills' className='sm:w-full h-screen bg-contain bg-slate-500  text-gray-300'>
      {/* Container */}
      <div className='sm:max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full bg-contain'>
          ...
          <div className='sm:w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
